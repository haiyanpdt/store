        ...
        <div class="section" id="order-review-wp">
            ...
            <div class="section-detail">
                <table class="shop-table">
                    ...
                    <tbody>
                        <tr class="cart-item">
                            <td class="product-name">235 đường Hoàng Quốc Việt <strong class="product-quantity">x 1</strong></td>
                        </tr>
                        <tr class="cart-item">
                            <td class="product-name">Mobile: +84369005764<strong class="product-quantity">x 2</strong></td>
                        </tr>
                        <tr class="cart-item">
                            <td class="product-name">Fax: <strong class="product-quantity">x 2</strong></td>
                        </tr>
                        <tr class="order-total">
                            <td><strong class="total-price">Email: luonngochai29@gmail.com </strong></td>
                        </tr>
                    </tbody>
                    <tfoot>
                        <tr class="order-total">
                        		...
                        		<strong class="total-price">
                        			<ul>
										<li style="display: inline-block; padding: 0px 20px; font-size: 50px;">
											<a style="color:gray;" href="https://www.facebook.com/nhaimh/"><i class="fa fa-facebook"></i></a>
										</li >
										<li style="display: inline-block;padding: 0px 20px;font-size: 50px;">
										...
										<li style="display: inline-block;padding: 0px 20px;font-size: 50px;">
											<a style="color:gray;" href="https://www.youtube.com/watch?v=aCfbV5Tp_wM&t=2271s"><i  class="fa fa-youtube"></i></a>
										</li>
									</ul>
                        		</strong>
                        	</td>
